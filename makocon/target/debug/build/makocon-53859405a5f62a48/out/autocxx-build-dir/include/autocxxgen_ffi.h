...
inline std::unique_ptr<std::string> autocxx_make_string_0x995a20c818150c48(::rust::Str str) { return std::make_unique<std::string>(std::string(str)); }
inline KVStore* KVStore_autocxx_alloc_autocxx_wrapper_0x995a20c818150c48()  { return new_appropriately<KVStore>();; }
inline void KVStore_autocxx_free_autocxx_wrapper_0x995a20c818150c48(KVStore* arg0)  { delete_appropriately<KVStore>(arg0);; }
inline void KVStore_new_autocxx_autocxx_wrapper_0x995a20c818150c48(KVStore* autocxx_gen_this)  { new (autocxx_gen_this) KVStore(); }
inline void KVStore_destructor_autocxx_wrapper_0x995a20c818150c48(KVStore* arg0)  { arg0->KVStore::~KVStore(); }
